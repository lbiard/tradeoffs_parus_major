...
model {
  ...
  vector[C] re_season_r = z_season_r * sd_r;
 ...
 //initialize mean linear predictors
  vector[N] mu_g = mu_growth[id_g_lm] + re_season_g[c_id_g] + col(mat_nestbox, 1)[plot_id_g]; 
...
generated quantities{
  ...
  vector[N] mu_g_bis = mu_growth_bis[id_g_lm] + re_season_g_bis[c_id_g] + col(mat_nestbox_bis, 1)[plot_id_g];
  vector[M] mu_f_bis = mu_fecundity_bis[id_f_lm] + re_season_f_bis[c_id_f] + col(mat_nestbox_bis, 2)[plot_id_f];
  vector[M] mu_r_bis = mu_recruitment_bis[id_f_lm] + re_season_r_bis[c_id_f] + col(mat_nestbox_bis, 3)[plot_id_f];
